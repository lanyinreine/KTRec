...
def get_exp_configure(agent, dataset):
    config_dict = {
        'embed_size': 48,
        'hidden_size': 64,
        'output_size': 1,
    ...
    if agent == 'RR':
        feature_path = './data/'+dataset+'/matrix/feature.csv'
    ...
    if agent == 'TGCN':
        ...
        adj_path = './data/'+dataset+'/matrix/adj_m.csv'
...
def get_options(parser: ArgumentParser, reset_args=None):
    ...
    exp_configure = get_exp_configure(args.agent, args.dataset)
